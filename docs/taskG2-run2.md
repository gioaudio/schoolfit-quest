...
## Run 2 of 5 · Public schools, second half
...
All four are **public schools**, so a WA Public School Review should exist for each. Note that **Applecross and Shenton currently have zero independent sources of any kind** — every source held for them is the school's own website.
...
**Start with Willetton Senior High School now.**
