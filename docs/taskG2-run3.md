...
## Run 3 of 5 · Independent schools with no independent evidence
...
### 3. Carey Baptist College — Harrisdale

### 4. Christ Church Grammar School

These are independent schools, so **no WA Public School Review exists** — record `exists:false` and treat that absence as a finding in itself. **Hale, Carey and Christ Church currently have zero independent sources.** They are also among the most expensive schools in the set, so families are making very large decisions on marketing copy alone. Anything you find is pure gain.
