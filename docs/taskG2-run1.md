...
## Run 1 of 5 · Public schools, first half
...
All four are **public schools**, which means a WA Public School Review should exist for each one. Those reviews are the single most valuable source in this entire project — external assessors with nothing to sell. Prioritise finding them.
