...
## Run 5 of 5 · Catholic and ACC schools, plus the new addition
...
Do **only** these 5. Do not stray outside the list — other runs are handling the rest, and duplicated work is wasted.

### 1. Corpus Christi College

### 2. Kennedy Baptist College

### 3. CBC Fremantle

### 4. Seton Catholic College

### 5. John XXIII College

Independent and Catholic schools — no WA Public School Review exists, so record `exists:false`. **John XXIII College is being newly added to the tool and has no existing data at all**, so everything you find for it is new. It is a Catholic co-educational school in Mount Claremont with Loreto and Jesuit heritage, competing in the ACC (sub-association NAS).
...
Complete all 5 schools. If you genuinely cannot, complete as many as you can **fully** and name the ones you did not reach. **Truncated data is worse than partial data, because the gaps stop being visible.**
...
**Start with Corpus Christi College now.**
